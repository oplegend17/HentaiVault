...
const FEATURE_PILLS = [
  { icon: Sparkles, label: "GIFs Only", desc: "Pure animated loop feed" },
  { icon: Zap,      label: "Instant Load", desc: "Frictionless speed" },
  { icon: Shuffle,  label: "Variety",    desc: "Infinite options" },
];
    ...
    <div className="space-y-8">
      ...
      <div className="pt-4 pb-2">
        ...
        <p className="font-body text-sm text-on-surface-variant max-w-md">
          Browse and enjoy high-quality animated loops, reaction GIFs, and character animations.
        </p>
      ...
      <div className="space-y-3">
        <SearchBar onSearch={() => { setPage(1); fetchGifs(true); }} placeholder="Search GIF tags, characters, series..." />
        <TagFilter />
        <TagCloud onTagSelect={() => { setPage(1); fetchGifs(true); }} />
      </div>
